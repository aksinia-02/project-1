...
/**
 * Repository class implementing BreedDao interface for JDBC operations
 */
@Repository
public class BreedJdbcDao implements BreedDao {
  ...
  /**
   * Constructs a new BreedJdbcDao with the specified NamedParameterJdbcTemplate.
   *
   * @param jdbcTemplate the NamedParameterJdbcTemplate used by the BreedJdbcDao
   */
  ...
  public Collection<Breed> search(BreedSearchDto searchParams) {
    LOG.trace("search parameters({})", searchParams);
  ...
  /**
   * Maps a row from the ResultSet to a Breed object.
   *
   * @param resultSet the ResultSet containing the data
   * @param i the current row index
   * @return the mapped Breed object

...
public class DataGeneratorBean {
  ...
  /**
   * Constructs a new DataGeneratorBean with the specified DataSource.
   *
  ...
  /**
   * Generates dummy data by executing an SQL script.
   *
   * @throws SQLException if an SQL exception occurs during the data generation process
   */
  @PostConstruct
  ...
  /**
   * Clears existing data by executing an SQL script.
   *
   * @throws SQLException if an SQL exception occurs during the data clearing process
   */

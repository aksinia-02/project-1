...
VALUES
    (-1, 'tournament1', '2023-12-12', '2023-12-13'),
    (-2, 'tournament2', '2022-03-02', '2022-03-09'),
    (-3, 'tournament3', '2012-10-28', '2012-11-03'),
    (-4, 'tournament4', '2023-09-08', '2023-10-01'),
    (-5, 'tournament5', '2023-10-10', '2023-10-17');

INSERT INTO participant (id, id_horse, tournament_id, entry_number, round_reached)
VALUES
    (-1, -1, -1, -1, 3),
    (-2, -2, -1, -1, 1),
    (-3, -3, -1, -1, 2),
